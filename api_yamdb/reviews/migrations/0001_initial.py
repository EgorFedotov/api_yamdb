...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='Category',
            fields=[
                ('commongroupmodel_ptr', models.OneToOneField(auto_created=True, on_delete=django.db.models.deletion.CASCADE, parent_link=True, primary_key=True, serialize=False, to='reviews.commongroupmodel')),
            ],
            bases=('reviews.commongroupmodel',),
        ),
        migrations.CreateModel(
            name='Genre',
            fields=[
