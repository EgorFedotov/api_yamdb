# Generated by Django 3.2 on 2023-02-03 16:52
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(max_length=256, verbose_name='Название')),
                ('year', models.PositiveSmallIntegerField(validators=[django.core.validators.MaxValueValidator(2100, 'Год еще не наступил'), django.core.validators.MinValueValidator(600, 'Минимальное значение 600')])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('score', models.IntegerField(default=0, validators=[django.core.validators.MaxValueValidator(10, 'Оценка не может быть выше 10'), django.core.validators.MinValueValidator(1, 'Оценка не может быть меньше 1')])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('title', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='genres', to='reviews.title')),
            ],
        ),
        migrations.CreateModel(
            name='Comment',
        ...
        migrations.AddConstraint(
            ...
            constraint=models.UniqueConstraint(fields=('genre', 'title'), name='constraint_pair'),
        ),
    ]
